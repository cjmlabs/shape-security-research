function ShapeSecurityRun(J)
{
    ...
    [
        ...
        "put", 
        "getElementById", 
        "vGCpTmhu3lo", "HyHXIiQflhuyW-gkU2Ipvu4Yug", 
        "S-kM", 
    ...
    */
    ...
    function ShapeBase64Decode(bytes) // originally function i(L) defined above
    {
        let base64 = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_";

        let byteArrayLength = Math.floor((bytes.length * 3) / 4);
        let byteArray = new Uint8Array(byteArrayLength);

        for (let bytePos = 0, byteArrayPos = 0; bytePos < bytes.length; bytePos = bytePos + 4, byteArrayPos = byteArrayPos + 3)
        {
            let byte0 = base64.indexOf(bytes.charAt(bytePos));
            let byte1 = base64.indexOf(bytes.charAt(bytePos + 1));
            let byte2 = base64.indexOf(bytes.charAt(bytePos + 2));
            let byte3 = base64.indexOf(bytes.charAt(bytePos + 3));

            let byteArrayValue0 = byte0 << 2 | byte1 >> 4;
            let byteArrayValue1 = (byte1 & 15) << 4 | byte2 >> 2;
            let byteArrayValue2 = (byte2 & 3) << 6 | byte3;

            byteArray[byteArrayPos] = byteArrayValue0;

            if (bytePos + 2 < bytes.length)
            {
                byteArray[byteArrayPos + 1] = byteArrayValue1;
            }

            if (bytePos + 3 < bytes.length)
            {
                byteArray[byteArrayPos + 2] = byteArrayValue2;
            }
        }
    ...
    function JH()
    {
        ...
        Object.defineProperty(Jj, "D",
        {
            value: D
        });

        Object.defineProperty(Jj, "x",
        {
            value: V
        });

        Object.defineProperty(Jj, "H",
        {
            value: W
        });

        Object.defineProperty(Jj, "M",
        {
            value: O
        });
    ...
    function(Il)
    {
        ...
        b1:
        {
            ...
            var Id = Y[IH];
            var IZ = ShapeBase64Decode(Id);
            var Io = ShapeBase64Decode(ID);
    ...
    function(Ii)
    {
        ...
        var yE = Y[Ih];
        var yv = ShapeBase64Decode(yE);
        var yI = ShapeBase64Decode(Im);
    ...
    function(yr)
    {
        ...
        var yF = Y[ye];
        var ym = ShapeBase64Decode(yF);
        var au = ShapeBase64Decode(yL);
    ...
    function(aI)
    {
        ...
        b0:
        {
            ...
            var aH = Y[ay];
            var aj = ShapeBase64Decode(aH);
            var aS = ShapeBase64Decode(aX);
    ...
    function(Ki)
    {
        ...
        var CJ = Y[Kc];
        var CE = ShapeBase64Decode(CJ);
        var Cv = ShapeBase64Decode(KF);
    ...
    function(CQ)
    {
        ...
        b0:
        {
            ...
            var Cq = Y[CN];
            var Cw = ShapeBase64Decode(Cq);
            var CG = ShapeBase64Decode(Cz);
    ...
    function(Ci)
    {
        ...
        var XE = Y[Cc];
        var Xv = ShapeBase64Decode(XE);
        var XI = ShapeBase64Decode(CF);
    ...
    function(Xn)
    {
        ...
        b1:
        {
            ...
            var XT = Y[Xg];
            var XF = ShapeBase64Decode(XT);
            var Xm = ShapeBase64Decode(Xi);
    ...
    function(lr)
    {
        ...
        b0:
        {
            ...
            var lF = Y[lg];
            var lm = ShapeBase64Decode(lF);
            var Bu = ShapeBase64Decode(lL);
    ...
    function(Bi)
    {
        Bi.w[Bi.w.length] = ShapeSecurityRun;
    }, 
    ...
    function(HL)
    {
        ...
        b0:
        {
            ...
            var jE = Y[Hh];
            var jv = ShapeBase64Decode(jE);
            var jI = ShapeBase64Decode(HF);
    ...
    function(jU)
    {
        ...
        var jW = Y[jH];
        var jO = ShapeBase64Decode(jW);
        var js = ShapeBase64Decode(jS);
    ...
    function(ji)
    {
        ...
        b0:
        {
            ...
            var SJ = Y[jL];
            var SE = ShapeBase64Decode(SJ);
            var Sv = ShapeBase64Decode(jT);
    ...
    function(SC)
    {
        ...
        var SV = Y[Sl];
        var SD = ShapeBase64Decode(SV);
        var SW = ShapeBase64Decode(SB);
    ...
    function(Sx)
    {
        ...
        b1:
        {
            ...
            var SA = Y[SM];
            var Sb = ShapeBase64Decode(SA);
            var SP = ShapeBase64Decode(Sq);
    ...
    function(SF)
    {
        ...
        var Va = Y[Vu];
        var VK = ShapeBase64Decode(Va);
        var VC = ShapeBase64Decode(VE);
    ...
    function(VB)
    {
        ...
        b1:
        {
            ...
            var VO = Y[Vj];
            var Vs = ShapeBase64Decode(VO);
            var Vd = ShapeBase64Decode(VS);
    ...
    function(DC)
    {
        ...
        b0:
        {
            ...
            var DD = Y[DX];
            var DW = ShapeBase64Decode(DD);
            var DO = ShapeBase64Decode(DH);
    ...
    function(Db)
    {
        ...
        b1:
        {
            ...
            var DT = Y[DP];
            var DF = ShapeBase64Decode(DT);
            var Dm = ShapeBase64Decode(Di);
    ...
    function(WB)
    {
        ...
        b0:
        {
            ...
            var Ws = Y[WH];
            var Wd = ShapeBase64Decode(Ws);
            var WZ = ShapeBase64Decode(WV);
    ...
    function(Wi)
    {
        ...
        b0:
        {
            ...
            var OE = Y[WL];
            var Ov = ShapeBase64Decode(OE);
            var OI = ShapeBase64Decode(WF);
    ...
    function(Os)
    {
        ...
        b1:
        {
            ...
            var Op = Y[OZ];
            var Of = ShapeBase64Decode(Op);
            var Oz = ShapeBase64Decode(Oo);
    ...
    function(Ow)
    {
        ...
        b1:
        {
            ...
            var Oi = Y[OG];
            var OL = ShapeBase64Decode(Oi);
            var Oh = ShapeBase64Decode(On);
    ...
    function(sr)
    {
        ...
        var sm = Y[se];
        var du = ShapeBase64Decode(sm);
        var dJ = ShapeBase64Decode(sc);
    ...
    function(dM)
    {
        ...
        var dA = Y[dq];
        var db = ShapeBase64Decode(dA);
        var dP = ShapeBase64Decode(dw);
    ...
    function(de)
    {
        ...
        b1:
        {
            ...
            var Zu = Y[dL];
            var ZJ = ShapeBase64Decode(Zu);
            var ZE = ShapeBase64Decode(dc);
    ...
    function(QK)
    {
        ...
        b0:
        {
            ...
            var QV = Y[QC];
            var QD = ShapeBase64Decode(QV);
            var QW = ShapeBase64Decode(QB);
    ...
    function(NE)
    {
        ...
        b0:
        {
            ...
            var NU = Y[Nv];
            var Nl = ShapeBase64Decode(NU);
            var NB = ShapeBase64Decode(Na);
    ...
    function(kS)
    {
        ...
        var kQ = Y[kW];
        var kN = ShapeBase64Decode(kQ);
        var kk = ShapeBase64Decode(ks);
    ...
    function(kP)
    {
        ...
        var kh = Y[kn];
        var kc = ShapeBase64Decode(kh);
        var kT = ShapeBase64Decode(ke);
    ...
    function(py)
    {
        ...
        b1:
        {
            ...
            var pS = Y[pK];
            var pV = ShapeBase64Decode(pS);
            var pD = ShapeBase64Decode(pl);
    ...
    function(fC)
    {
        ...
        b1:
        {
            ...
            var fS = Y[fU];
            var fV = ShapeBase64Decode(fS);
            var fD = ShapeBase64Decode(fl);
...
{
    ShapeSecurityRun(window);
}

else if (typeof global !== "undefined" && global !== null && global.global === global)
{
    ShapeSecurityRun(global);
}

else
{
    ShapeSecurityRun(this);
}
