(function u(J) {
  ...
  var A = H(G);
  var b = H(t);
  var P = typeof Uint8Array === 'function' ? Uint8Array : U;
  var Y = [
  ...
  [
    function(vw) {
      var vG = Jd[vw.T];
      vw.T += 1;
      vw.w[vw.w.length - (2 + vG)] = S(
        vw.w[vw.w.length - (1 + vG)],
        vw.w[vw.w.length - (2 + vG)],
        vw.w.H(vw.w.length - vG)
      );
      vw.w.length -= 1 + vG;
    },
    function(vt) {
    ...
    function(BO) {
      'use strict';
      BO.w[BO.w.length - 2] = delete BO.w[BO.w.length - 2][
        BO.w[BO.w.length - 1]
      ];
      BO.w.length -= 1;
    },
    ...
    function(HQ) {
      HQ.w[HQ.w.length - 2] =
        HQ.w[HQ.w.length - 2] instanceof HQ.w[HQ.w.length - 1];
      HQ.w.length -= 1;
    },
    function(HN) {
      var Hk = Jd[HN.T];
